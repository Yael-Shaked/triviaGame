        ...
        <div>
          {answers.map((answer, index) => (
            <button
              ...
              className={` text-2xl p-4 font-bold w-custom-wide text-center text-white mb-2 hover:bg-gray-400 transition border border-gray-800 bg-white bg-opacity-25 rounded-3xl ${isPressed ? pressedClasses : ""} ${score}`}
            >
              {answer}
            </button>
          ))}
